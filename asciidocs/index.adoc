...
** Man nimmt die Probleme unterteilt sie immer soweit kleiner in kleiner Probleme bis sie schaffbar sind
* Grobentwurf
...
*** Mocken (=vortäuschen)
**** beispielsweiße eine Datenbank vortäuschen wobei diese nur 3 einträge enthält.
