...
Nach jedem Sprint ist das Produkt lauffähig

*Business Value*...  der Grund weshalb es die Firma gibt/alles womit die Firma Geld verdient
...
* Betroffende des Projekts allerdings nicht involviert
